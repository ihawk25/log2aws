...
cat /u/DDS/scripts/ctab3 | awk '{print $6;}' > /u/DDS/scripts/ctab4

echo -e "\n\nSEND Scripts for $DealerNum:" > /u/DDS/scripts/ctab5
while read -r line; do
        sed -i -e 's/66.45.71.221/ftp.dmotorworks.com/g' $line
        echo $line >> /u/DDS/scripts/ctab5
done < /u/DDS/scripts/ctab4

aws s3 cp /u/DDS/scripts/ctab5 s3://ddsdealerlog/SEND/$DealerNum.txt
