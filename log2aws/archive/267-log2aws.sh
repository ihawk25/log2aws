...
#####ONE-TIME COMMAND#####
find /u/AGO -type f -name "SEND*" -print0 | xargs -0 sed -i 's/66.45.71.221/ftp.dmotorworks.com/g'
find /u/AGO -type f -name "SEND*" -print0 | xargs -0 sed -i 's/74.203.79.138/ftp.integralink.com/g'
